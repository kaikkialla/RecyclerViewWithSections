package com.example.tiget.recyclerviewwithsections;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void addRecyclerHeaders()
    {
        SectionHeaderProvider<Galaxy> sh=new SimpleSectionHeaderProvider<Galaxy>() {
            ...
            public View getSectionHeaderView(@NonNull Galaxy Galaxy, int i) {
                View view = LayoutInflater.from(MainActivity.this).inflate(R.layout.header_layout, null, false);
    ...
    private void bindData()
    {
        ...
        for (final Galaxy galaxy : Galaxys) {
